    ...
    <div class="home-container container-fluid d-flex flex-column justify-content-center align-items-center text-center text-white w-50 gap-3">
        ...
        <div class="d-flex flex-column gap-3">
            ...
            <form class="d-flex justify-content-center">
                ...
                <a href="<?php echo e(url('/films')); ?>" class="btn btn-danger py-2 px-3" type="submit" style="white-space: nowrap;">Get Started ></a>
            </form>
        </div>
    </div>
...
<?php /**PATH D:\Files Kuliah\INF_Semester_3\Backend Web Programming\TugasM5\resources\views/english.blade.php ENDPATH**/ ?>