...
<body class="film-body pt-5">
    ...
    <div class="container-fluid text-white mt-5">
        <div><i class="bi bi-funnel-fill"></i> Filter by Genre:
            <a href="{{ url('/films/serial') }}" class="btn btn-sm {{ $selected_genre == 'All' ? 'btn-danger' : 'btn-outline-light' }}">All Genres</a>
            <a href="{{ url('/films/serial/aksi') }}" class="btn btn-sm {{ $selected_genre == 'Aksi' ? 'btn-danger' : 'btn-outline-light' }}">Aksi</a>
            <a href="{{ url('/films/serial/animasi') }}" class="btn btn-sm {{ $selected_genre == 'Animasi' ? 'btn-danger' : 'btn-outline-light' }}">Animasi</a>
            <a href="{{ url('/films/serial/biografi') }}" class="btn btn-sm {{ $selected_genre == 'Biografi' ? 'btn-danger' : 'btn-outline-light' }}">Biografi</a>
            <a href="{{ url('/films/serial/drama') }}" class="btn btn-sm {{ $selected_genre == 'Drama' ? 'btn-danger' : 'btn-outline-light' }}">Drama</a>
            <a href="{{ url('/films/serial/fantasi') }}" class="btn btn-sm {{ $selected_genre == 'Fantasi' ? 'btn-danger' : 'btn-outline-light' }}">Fantasi</a>
            <a href="{{ url('/films/serial/horror') }}" class="btn btn-sm {{ $selected_genre == 'Horror' ? 'btn-danger' : 'btn-outline-light' }}">Horror</a>
            <a href="{{ url('/films/serial/keluarga') }}" class="btn btn-sm {{ $selected_genre == 'Keluarga' ? 'btn-danger' : 'btn-outline-light' }}">Keluarga</a>
            <a href="{{ url('/films/serial/komedi') }}" class="btn btn-sm {{ $selected_genre == 'Komedi' ? 'btn-danger' : 'btn-outline-light' }}">Komedi</a>
            <a href="{{ url('/films/serial/misteri') }}" class="btn btn-sm {{ $selected_genre == 'Misteri' ? 'btn-danger' : 'btn-outline-light' }}">Misteri</a>
            <a href="{{ url('/films/serial/musik') }}" class="btn btn-sm {{ $selected_genre == 'Musik' ? 'btn-danger' : 'btn-outline-light' }}">Musik</a>
            <a href="{{ url('/films/serial/petualangan') }}" class="btn btn-sm {{ $selected_genre == 'Petualangan' ? 'btn-danger' : 'btn-outline-light' }}">Petualangan</a>
            <a href="{{ url('/films/serial/romantis') }}" class="btn btn-sm {{ $selected_genre == 'Romantis' ? 'btn-danger' : 'btn-outline-light' }}">Romantis</a>
            <a href="{{ url('/films/serial/sejarah') }}" class="btn btn-sm {{ $selected_genre == 'Sejarah' ? 'btn-danger' : 'btn-outline-light' }}">Sejarah</a>
            <a href="{{ url('/films/serial/thriller') }}" class="btn btn-sm {{ $selected_genre == 'Thriller' ? 'btn-danger' : 'btn-outline-light' }}">Thriller</a>
        </div>
