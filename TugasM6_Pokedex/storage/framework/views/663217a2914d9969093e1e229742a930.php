        ...
        <div class="row">
            <div class="col-md-4 bg-light border border-4 border-end-0 border-navy rounded-start-5 d-flex flex-column justify-content-between align-items-center p-4">
                <div class="d-flex justify-content-between align-items-center w-100">
                    <a class="btn bg-navy btn-primary border-navy" href="<?php echo e(route('items.index', ['type' => 'All'])); ?>"><i class="bi bi-arrow-left"></i> Back to Items</a>
                    <span class="bg-navy rounded-pill fw-bold text-white p-2 px-3">#<?php echo e(sprintf("%03d", $item['id'])); ?></span>
                </div>
                <img src="<?php echo e($item['icon']); ?>" class="img-fluid rounded-start" alt="<?php echo e($item['name']); ?>" width="150">
                <div class="">
                    <h1 class="card-title mb-3"><?php echo e($item['name']); ?></h1>
            ...
            <div class="col-md-8 bg-navy rounded-end-5 text-white p-4 d-flex flex-column">
                ...
                <span class="bg-regular rounded-2 text-start p-3"><?php echo e($item['effect']); ?></span>
                <span class="fs-5 fw-bold mb-3 mt-4">Description</span>
                <small class="bg-white text-dark rounded-2 text-start p-3"><?php echo e($item['description']); ?></small>
...
<?php echo $__env->make("layouts.template", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Files Kuliah\INF_Semester_3\Backend Web Programming\TugasM6\resources\views/pages/items/show.blade.php ENDPATH**/ ?>